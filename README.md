...
毎朝の縦型ショート動画「**新作AIツール N選**」（2〜5 本、使える新作が 5 本以上ある日は 5選）を作り、YouTube Shorts と Instagram Reels に投稿する。出典は Product Hunt の公式フィードで、扱うのは直近 48 時間以内に公開されたツールだけ。順位・票数は名乗らない（2026-09-15 オーナー決定）。sns-hub の**ジャンル試行 #1: AI ツール TOP5（Product Hunt）**（2026-09-16 開始予定、判定 2026-09-30）。
...
fetch-product-hunt.yml (18:30 JST 前夜 / 06:30 JST 予備)
  Product Hunt 公式 Atom フィード（PH_SOURCE=feed。前回のスナップショットから掲載の初出を引き継ぐ）
...
npm run dry-run:ranking       # 旧 ranking（TOP5）のサンプル。API は使わない決定のため参考用
```

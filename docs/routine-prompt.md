...
- Product Hunt のデータは**公式フィードだけ**を使う（2026-09-15 オーナー決定。公式 API は使わない。`docs/strategy.md` の「取得モード」）。この手順書に書かれた取得方法以外で Product Hunt のデータを集めない。**順位・票数・受賞・人気（「Product Hunt で話題」など）・「TOP」「ランキング」は名乗らない**（見せ方は「新作AIツール N選」）。**「話題の」「人気の」「注目の」「急上昇」「バズっている」「定番の」のような、順位や票数を出さない人気の言い回しも同じく使わない**（フィードには人気を示すデータが無いため。第三者アプリについても使わない = 「人気のSlackと連携」ではなく「Slackと連携」）
...
- NG: 順位・票数・受賞・人気（「Product Hunt で話題」「話題の」「人気の」「注目の」「急上昇」「バズっている」「定番の」など）・「ランキング」「TOP」に触れる（検証エラー）/ 体言止め / 「最強」「神」などの誇大表現 / 確認していない料金や機能の断定 / 英語タグラインの直訳
